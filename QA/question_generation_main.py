...
class QuestionGeneration:
    ...
    def generate_questions_dict(self, document):
        ...
        print(f'Questions Dict after extraction: {self.questions_dict}')  # Debug statement to print the extracted questions
        ...
        print(f'Questions Dict with options: {self.questions_dict}')  # Debug statement to print questions with options
